...
module.exports = (function() {
  ...
  const tinyses = bnf`
    ...
    # Omit "arguments" from IDENT in TinySES.
    RESERVED_WORD ::= 
    ...
    pattern ::=
      literal                                              ${n => ['matchData',JSON.parse(n)]}
    ...
    # lValue is only IDENT or elementExpr in TinySES.
